...
<body class=" bg-white">
    ...
    <div class="w-[771.67px] h-[1036.75px] left-[-105.73px] top-[-72.30px] absolute">
      <div class="w-[851.90px] h-[1951.32px] left-[57.19px] top-[80.11px] absolute origin-top-left rotate-[-7.44deg] bg-white bg-opacity-50"></div>
      <div class="w-[871.90px] h-[1200.32px] left-[-50px] top-[87.65px] absolute origin-top-left rotate-[-7.44deg] bg-red-600"></div>
      <div class="w-auto h-[60.36px] px-[50px] py-3.5 left-[162.73px] top-[635.70px] absolute bg-red-700 rounded-[10px] shadow justify-center items-center gap-2.5 inline-flex">
        <div class="text-stone-50 text-2xl font-bold font-['Inria Sans']">DAFTAR SEKARANG</div>
      </div>
    </div>
    <h1 class="w-[672px] h-[146.03px] left-[58px] top-[274.21px] absolute text-white text-[40px] font-bold font-['Inria Sans']">Dapatkan Pengalaman<br/>Berharga dengan Bergabung<br/>bersama kami!</h1>
    <div class="left-[42px] top-[25.11px] absolute justify-center items-center gap-[1455px] inline-flex">
      ...
      <div class="self-stretch justify-start items-center gap-[61px] inline-flex">
        ...
        <div class="w-[150px] h-[39.53px] px-[45px] py-3.5 bg-red-600 rounded-[10px] shadow justify-center items-center gap-2.5 flex">
