...
@section('content')
    <div class="w-full h-[770px] mx-[60px] relative">
        ...
        <div class="w-[376.41px] h-[458.83px] left-[836.21px] top-[362.17px] absolute">
            <div
                class="w-[376.41px] h-[458.83px] left-0 top-0 absolute backdrop-blur-sm bg-white/30 rounded-[20px] shadow overflow-auto">
                <div class="w-full h-[80px] sticky top-0 left-[30.97px] bg-w z-40">
                    <h2
                        class="w-[272.78px] h-[29.99px] left-[5px] top-[25px] absolute text-center text-neutral-800 text-[25px] font-bold font-['Inria Sans']">
                ...
                <a href="{{ route('anggota.presensi') }}"
                    class="left-[250px] pt-[390px] top-[30px] absolute text-center text-neutral  hover:underline cursor-pointer text-md font-bold font-['Inria Sans']">
                    Selengkapnya</a>
            </div>
        </div>
        {{-- END WIDGET PRESENSI --}}
                                ...
                                <tr class="bg-gray-100 odd:bg-white hover:bg-gray-100">
                                    ...
                                    <td class="flex items-center px-6 py-4 rounded-br">
                                        <a href="javascript:void(0);" title="Terima"
                                            onclick="handleStatus('{{ route('anggota.pendaftar.updateStatus', ['id' => $request->id_pendaftar]) }}', 'terima')"
                                            class="font-medium text-green-600  hover:underline">Terima
                                        </a>
                                        <a href="javascript:void(0);" title="Tidak Terima"
                                            onclick="handleStatus('{{ route('anggota.pendaftar.updateStatus', ['id' => $request->id_pendaftar]) }}', 'tidak')"
        ...
        <div class="w-[1210.24px] h-[68.82px] left-[2.38px] top-0 absolute">
            ...
            <div class="w-[24.58px] h-[24.58px] left-[30.73px] top-[23.60px] absolute"><iconify-icon
                    icon="solar:hand-shake-line-duotone" style="color: #252525; opacity: 50%;" height="24.58px"
        ...
        <div class="w-[1212.62px] h-[232.04px] left-[2.38px] top-[87.51px] absolute">
            ...
            <div class="w-[345.44px] h-[232.04px] left-0 top-0 absolute">
                ...
                <div class="w-[48.18px] h-[48.18px] left-[139.03px] top-[24.58px] text-neutral-700 absolute">
                    <iconify-icon icon="fluent-mdl2:message-friend-request" width="48.18" height="48.18"></iconify-icon>
                </div>
            </div>
