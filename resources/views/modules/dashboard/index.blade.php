...
@section('content')
        {{-- ALERT BERHASIL SECTION --}}
        @if (Session::has('success'))
            <div class="w-[303px] h-[70px] left-[769px] top-[15px] absolute">
                <div class="alert alert-success ">
                    <div class="w-[303px] h-[70px] left-0 top-0 absolute bg-white rounded-[23px] shadow"></div>
                    <div class="left-[20px] top-[15px] absolute">
                        <iconify-icon icon="icon-park-solid:success" height="45" width="45"
                            style="color: #0e972c;"></iconify-icon>
                        <span
                            class="w-[400px] h-[27px] left-[-40px] top-[9px] absolute text-center text-black text-2xl font-bold font-['Inria Sans']">
                            {{ Session::get('success') }}
                        </span>
                    </div>
                </div>
            ...
            <script>
                ...
                // buat ngatur timeout untuk menghilangkan elemen eek
                setTimeout(function() {
                    // nyembunyiin elemen pakai efek fadeOut
                    alertElement.style.opacity = 0;
                    alertElement.classList.remove('show');
                }, 1500);
            </script>
        @endif
        {{-- END ALERT BERHASIL SECTION --}}
                ...
                <div class="w-full h-[821px] relative">
                    ...
                    <div class="w-[1210.24px] h-[68.82px] left-[2.38px] top-0 absolute">
                        ...
                        <div class="w-[24.58px] h-[24.58px] left-[26.73px] top-[23.60px] absolute"><iconify-icon
                                icon="ic:outline-notifications-active" style="color: #cc0606;" height="24.58px"
                    ...
                    <div class="w-[1212.62px] h-[232.04px] left-[2.38px] top-[87.51px] absolute">
                        <div class="w-[345.44px] h-[232.04px] left-0 top-0 absolute">
                            <div
                                class="w-[345.44px] h-[183.86px] left-0 top-[48.18px] absolute bg-white rounded-[20px] shadow">
                            </div>
                            <h2
                        ...
                        <div class="w-[343.06px] h-[232.04px] left-[869.56px] top-0 absolute">
                            <div
                                class="w-[340.68px] h-[183.86px] left-0 top-[48.18px] absolute bg-white rounded-[20px] shadow">
                            </div>
                            <h1
